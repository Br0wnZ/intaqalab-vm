...
export class MaterialService implements MasterDataService<MasterDataDefault> {
  readonly #crud = injectMasterDataResource<MasterDataDefault>(`${injectPlanningEndpoint()}/target-materials`);
