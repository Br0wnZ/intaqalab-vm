...
import { EventLogMeasuresStore } from './measures.store';
...
describe('EventLogMeasuresStore', () => {
  let store: InstanceType<typeof EventLogMeasuresStore>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [EventLogMeasuresStore, { provide: MeasuresService, useValue: mockService }],
    });

    store = TestBed.inject(EventLogMeasuresStore);
  });
