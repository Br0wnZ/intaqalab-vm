 ...
 */
export function mapBackendToLocal(seriesArmament: SeriesArmamentData[]): ArmamentSerie[] {
...
export function buildSeriesFromStore(
  ...
  seriesArmament?: SeriesArmamentData[],
): ArmamentSerie[] {
 ...
 */
export function mapLocalToRequest(series: ArmamentSerie[]) {
