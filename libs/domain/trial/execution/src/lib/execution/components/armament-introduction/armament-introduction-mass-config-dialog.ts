  ...
  template: `
    ...
    <mat-dialog-content intaReadonlyContent class="flex flex-col gap-4 !pt-2">
      ...
      <mat-form-field appearance="outline" subscriptSizing="dynamic" class="w-full mb-2">
        <mat-label>{{ 'TRIAL_EXECUTION.WIDGETS.ARMAMENT_INTRODUCTION.MASS_CONFIG_SERIES_LABEL' | translate }}</mat-label>
        <mat-select
          multiple
...
export class ArmamentIntroductionMassConfigDialog {
  readonly #dialogRef = inject<
    MatDialogRef<ArmamentIntroductionMassConfigDialog, ArmamentIntroductionMassConfigDialogResult>
  >(MatDialogRef);
