...
export class ShotWidgetComponent extends BaseFormWidgetComponent {
  ...
  // 🧭 Dirty por valor: si el usuario revierte un campo a su valor guardado,
  // el formulario vuelve a estar limpio (a diferencia de form().dirty(), que es pegajoso).
  readonly #dirtyTracker = createDirtyTracker(() => this.shotModel());
