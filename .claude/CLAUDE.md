...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-14 (commit 0a1e0af). Confidence: 99%.
...
- `libs/domain/trial/planning/src/lib/components/shooting-conditions/shooting-conditions.ts` — 1 bug fix, last fix 12 days ago; 11 commits/90d
- `libs/domain/trial/planning/src/lib/components/armament/massive-shots-configuration-dialog.ts` — 1 bug fix, last fix 12 days ago; 7 commits/90d
- `libs/domain/trial/planning/src/lib/components/armament/armament-row.ts` — 1 bug fix, last fix 12 days ago; 8 commits/90d
- `libs/domain/trial/planning/src/lib/components/armament/update-armament-dialog.ts` — 1 bug fix, last fix 12 days ago; 4 commits/90d
- `libs/domain/trial/planning/src/lib/components/armament/armament.spec.ts` — 1 bug fix, last fix 12 days ago; 7 commits/90d

### Code health

Three co-equal signals: defect risk 8.42/10 avg, hotspot health 6.0/10 (stable), worst `libs/domain/trial/planning/src/lib/components/munitions/massive-munitions-configuration-dialog/massive-munitions-configuration-dialog.ts` at 1.9/10 · maintainability 9.27/10 · performance risk 3 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
