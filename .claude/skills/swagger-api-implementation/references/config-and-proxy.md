# Configuración de Endpoints y Proxy

Cada API del backend tiene su propia configuración de endpoint y regla de proxy. Cuando implementes una API nueva, verifica si ya existe un endpoint registrado o si necesitas crear uno.
