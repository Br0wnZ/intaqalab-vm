...
<div ngAccordionGroup [multiExpandable]="false">
  <div class="accordion-item">
    <button panelId="panel-1" ngAccordionTrigger class="accordion-header">
      Section 1
      <span class="icon">▼</span>
    </button>
    <div panelId="panel-1" ngAccordionPanel class="accordion-panel">
...
<ul ngListbox orientation="horizontal" [multi]="true" [(values)]="selectedItems">
...
<div ngCombobox [readonly]="true">
  ...
  <ng-template ngComboboxPopupContainer>
    <ul ngListbox class="dropdown-menu" [(values)]="selectedValue">
...
<ul ngMenu class="menu" #fileMenu="ngMenu">
...
<div ngToolbar class="toolbar">
  <div ngToolbarWidgetGroup role="group" aria-label="Formatting" [multi]="true">
...
```html
<table ngGrid class="grid-table" [multi]="true" [enableSelection]="true">
  <tr ngGridRow>
