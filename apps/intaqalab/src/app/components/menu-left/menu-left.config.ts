...
export const ACTION_ROUTES: Partial<Record<MenuAction, string>> = {
  ...
  WHAREHOUSE_MUNITION_NEW: '/warehouse-management/munitions',
  WHAREHOUSE_MUNITION_STOCK: '/warehouse-management/stock',
  WHAREHOUSE_MUNITIONS_DUMPS: '/warehouse-management/munitions-dumps',
  WHAREHOUSE_DENOMINATIONS: '/warehouse-management/denominations',
  WHAREHOUSE_MUNITIONS_COMPONENTS: '/warehouse-management/munition-components',
  EVENT_LOG: '/event-log',
  EXECUTION: '/execution',
};
